...
# This file was *autogenerated* from the file Finite_Spaces/Colorings.sage
...
def kruskal(X):
	...
	C = {u:u for u in X}
	for e in E:
		if find(C, e[_sage_const_0 ]) != find(C, e[_sage_const_1 ]):
			T.append(e)
			union(C, e[_sage_const_0 ], e[_sage_const_1 ])
	return T
			...
			if(ind != -_sage_const_1 ):
				...
				for z in l:
					if(z != y):
						...
						rels.append(d[tuple(s1)] * d[tuple(s2)] * d[tuple(s4)]**-_sage_const_1  * d[tuple(s3)]**-_sage_const_1 )
	return  (F / rels)
